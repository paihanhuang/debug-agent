...
## Diagnosis
- VCORE floor is 600mV, which is higher than the expected 575mV for MMDVFS OPP3.
- DDR usage is impacting VCORE levels.

## Next Steps
- Investigate and adjust DDR voting mechanisms to reduce unnecessary DDR frequency scaling.
- Review MMDVFS settings to ensure VCORE floor is at the expected level.
